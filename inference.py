...
def main():
    ...
    if os.path.exists('data/test_with_rag_ranked_filtered_progress_1k_4epochs_1024_1k_512_model.csv'):
        shutil.copy('data/test_with_rag_ranked_filtered_progress_1k_4epochs_1024_1k_512_model.csv',
                    'data/test_with_rag_ranked_filtered_progress_backup_1k_4epochs_1024_1k_512_model.csv')
        mod_test = pd.read_csv('data/test_with_rag_ranked_filtered_progress_1k_4epochs_1024_1k_512_model.csv', on_bad_lines='skip', engine='python')
    else:
    ...
    for i, row in tqdm(null_responses.iterrows(), total=null_responses.shape[0]):
        ...
        with torch.no_grad():
            ...
            test.to_csv('data/test_with_rag_ranked_filtered_progress_1k_4epochs_1024_1k_512_model.csv', index=False)
    ...
    submission.to_csv('data/submission_with_rag_ranked_filtered_progress_1k_4epochs_1024_1k_512_model.csv', index=False)
